...
namespace DatovkaSharp.Tests
{
    ...
    public class SearchTests
    {
        ...
        public async Task FindDataBoxById_WithOwnDataBoxId_ShouldReturnResult()
        {
            ...
            ClassicAssert.IsTrue(ownInfoResult.IsSuccess, "Should get own data box info");
            ClassicAssert.IsNotNull(ownInfoResult.Data, "Own data box info should not be null");
            ...
            // Assert
            ClassicAssert.IsTrue(result.IsSuccess, "Search operation should succeed");
            ClassicAssert.IsNotNull(result.Data, "Search results should not be null");
        ...
        public async Task FindDataBoxById_WithKnownTestDataBoxId_ShouldCompleteSuccessfully()
        {
            ...
            ClassicAssert.Pass($"Search completed successfully for data box ID: {testDataBoxId}");
        }
    }
}
